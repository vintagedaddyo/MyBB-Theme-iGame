...
<br />
        <a class="igame_welcome_button_register" href="' . $mybb->settings['bburl'] . '/member.php?action=register"><i class="fa fa-plus-circle fa-fw igame_welcome_button_icon"></i> 
            ' . $lang->igame_welcomeguest_createacct . '
      </a>
        <a class="igame_welcome_button_login" href="' . $mybb->settings['bburl'] . '/member.php?action=login"onclick="$(\'#quick_login\').modal({ fadeDuration: 250, keepelement: true }); return false;"><i " class="fa fa-check-circle-o fa-fw igame_welcome_button_icon"></i> ' . $lang->igame_welcomeguest_loginacct . '</font>
      </a>
     </span>
    </div>
    <br />
